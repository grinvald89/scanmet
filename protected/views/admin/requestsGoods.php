	...
	<div class="tableSite cabinet big">
		<table>
			...
			<tr ng-repeat="element in x_data_new">
				...
				<td class="button" style="width:40px;" ng-click="disallowGoods($index)">&#10008;</td>
				<td class="button" style="width:40px;" ng-click="approvedGoods($index)">&#10003;</td>
			</tr>
		</table>
	</div>
	<div class="buttons admin">
		<div class="button admin group" ng-click="disallowCheckedGoods()">Отклонить выбранные</div>
		<div class="button admin group" ng-click="approvedCheckedGoods()">Подтвердить выбранные</div>
	</div>
</div>