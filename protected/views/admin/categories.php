...
<div class="tableSite cabinet big" ng-init="nameData='goodsFromCategories'"><!-- BEGIN .table.cabinet.big -->
	<table ng-init="getPage(nameData)">
		<tr>
			...
			<th style="width:700px;">Категории</th>
		...
		<tr ng-repeat="element in x_data">
			...
			<td>{{ element.name }}</td>
			<td  ng-bind-html-unsafe="element.typeCode">{{ element.typeCode }}</td>
			<td></td>
			<td class="button" style="width:40px;" ng-click="deleteCategory($index)">&#10008;</td>
			<td class="button" style="width:40px;" ng-click="saveTypeCategory($index)">&#10003;</td>
		</tr>
	</table>
